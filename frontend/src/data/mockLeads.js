...
export const mockHeatClusters = [
  {
    id: 'cluster_west_austin',
    label: 'West Austin Impact Surge',
    city: 'Austin',
    state: 'TX',
    status: 'hot',
    cluster_status: 'hot',
    ...
    active_claims: 15,
    likely_new_roofs: 11,
    total_properties: 164,
    scanned_properties: 142,
    predicted_roi_multiple: 4.7,
    radius_miles: 0.6,
    last_activity_at: '2024-01-25T15:10:00Z',
    lead_overlap: 27,
    map_center: { latitude: 30.2749, longitude: -97.7431 },
    bounding_box: {
      minLat: 30.265,
      maxLat: 30.286,
      minLon: -97.758,
    ...
    associated_scans: ['scan_001'],
    zip_codes: ['78701', '78703'],
    insurance_mix: {
      stateFarm: 0.28,
      usaa: 0.16,
      farmers: 0.14,
    ...
    ai_takeaway: 'Spike in hail-related permits with $28k median claim value. Prioritise premium replacements and concierge adjuster support.',
  },
  {
    id: 'cluster_east_side',
    label: 'East Side Roof Revival',
    city: 'Austin',
    state: 'TX',
    status: 'active',
    ...
    active_claims: 9,
    likely_new_roofs: 7,
    total_properties: 138,
    scanned_properties: 118,
    predicted_roi_multiple: 3.9,
    radius_miles: 0.55,
    last_activity_at: '2024-01-23T11:42:00Z',
    lead_overlap: 18,
    map_center: { latitude: 30.2618, longitude: -97.7184 },
    bounding_box: {
      minLat: 30.252,
      maxLat: 30.272,
      minLon: -97.732,
    ...
    associated_scans: ['scan_002'],
    zip_codes: ['78702', '78721'],
    insurance_mix: {
      progressive: 0.22,
      libertyMutual: 0.18,
      farmers: 0.15,
    ...
    ai_takeaway: 'Contractor competition is moderate. Promote financing bundles and maintenance add-ons to boost average deal size.',
  },
  {
    id: 'cluster_south_congress',
    label: 'South Congress Storm Path',
    city: 'Austin',
    state: 'TX',
    status: 'warming',
    ...
    active_claims: 6,
    likely_new_roofs: 5,
    total_properties: 112,
    scanned_properties: 94,
    predicted_roi_multiple: 3.2,
    radius_miles: 0.5,
    last_activity_at: '2024-01-21T09:18:00Z',
    lead_overlap: 12,
    map_center: { latitude: 30.2465, longitude: -97.7496 },
    bounding_box: {
      minLat: 30.238,
      maxLat: 30.255,
      minLon: -97.763,
    ...
    ai_takeaway: 'Permit volume is still building. Use nurture sequences to beat the rush before canvassing crews flood the area.',
  },
];
